...
**Governance/funding — the risk section.** The July snapshot read the commit history as "concentrated around Matt Campbell and Arnold Loubriat". A 2026-08-29 re-check of the repository (prompted by a maintainer's correction on Reddit) sharpens that to **one active maintainer**: since mid-March 2026 Arnold Loubriat ([DataTriny](https://github.com/DataTriny)) has authored 42 of 58 commits, merged all 54 pull requests and cut every release; Matt Campbell's last commit was 2026-03-04 (he still reviews and remains a crates.io owner). Loubriat is the only public member of the [AccessKit org](https://github.com/orgs/AccessKit/people) and describes the work as spare-time. Funding: the 2023–24 Sovereign Tech Fund programme administered through GNOME paid Campbell for Newton and the GTK↔AccessKit integration and is wrapped up ([GNOME STF report](https://blogs.gnome.org/tbernard/2025/04/11/gnome-stf-2024/)); one later institutional grant exists, which the July audit missed — an [NLnet NGI0 Commons Fund grant "iOS support for AccessKit"](https://nlnet.nl/project/AccessKit-iOS/) (start 2025-11), scoped to a feature and delivered as `accesskit_ios` 0.1.0 on 2026-05-11. There is no project-level funding channel (no FUNDING.yml; accesskit.dev's sponsor link goes to Campbell's page, 6 sponsors; Loubriat's lists 2 individual sponsors). The project remains active (accesskit 0.25.0, 2026-08-29). GTK 4.18 also merged an opt-in AccessKit backend ([GTK dev blog](https://blogs.gnome.org/gtk/2025/05/12/an-accessibility-update/)).
